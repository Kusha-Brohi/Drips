...
<div style=""> <!-- main Div -->
	...
	<div style="margin: 50px auto; color: #2a3342; border:7px solid #eee; ">
		...
		<h2 style="font-size: 16px; font-weight: inherit;">Dear {{$doctor_data['name']}}! Your portal account has been generated successfully please login to your acccount</h2>
	...
	<!--	<p style="font-size: 16px; font-weight: inherit;">Email: {{$doctor_data['email']}}</p>-->
		<p style="font-size: 16px; font-weight: inherit;">MDCN: {{$doctor_data['MDCN']}}</p>
		<p style="font-size: 16px; font-weight: inherit;">Password: {{$doctor_data['password']}}</p>
