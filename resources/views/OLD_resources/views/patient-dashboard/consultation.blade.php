                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-3 colsm-3 col-xs-12">
                                          <div class="billinglist">
                                           ...
                                           <input  class="mydate" type="date" min="{{date("Y-m-d")}}" name="date" placeholder="Date" id="date">
                                        </div>
                                     </div>
                                     <div class="col-md-3 colsm-3 col-xs-12">
                                            <div class="billinglist">
                                            <label id=labletime>Select Time</label>
                                             <input type="time" name="timing" id=time>
                                        </div>
                                       </div> 
                                         <div class="col-md-3 colsm-3 col-xs-12">
                                             <div class="billinglist">
                                    ...
                                    <div class="billinglist docterlist">
                                            ...
                                            <option value="Any">Any</option>
                                              ...
                                              @foreach($speciality as $value)
                                                 <option value="{{$value->symtom}}" @if($expertise == $value->symtom ) selected @endif  >{{$value->name}}</option>
                                              <!-- <option value="{{$value->symtom}}">{{$value->name}}</option> -->
                                              @endforeach
                                            </select>
                                 ...
                                 <table class="table">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                          ...
                                          <?php
                                          $speciality_list = DB::table('specialities')->where('symtom',$data->expertise)->first();
                        ...
                        <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="ecc_card_wrap">
                              <div class="logo">
                                  <img src="{{asset($logo->img_path)}}" style="width: 50%;" class="img-responsive" alt="">
                              </div>
