                ...
                <div class="col-sm-12 col-md-12" id="content">
                    ...
                    <div class="row paddingtop">
                        <div id="accordion">
                            ...
                            <?php $myorder = DB::table('patient_orderlist')->where('testresult_by', '=', 'patient')->where('consultation_id', $consult->id)->get(); ?>
                              ...
                              <div id="collapseOne{{$key}}" class="collapse @if($key == 0) show @endif" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    @foreach($order as $value)
                                     <?php
                                     $doctor= DB::table('patients')->where('user_id',$value->patient_id)->first();
                                    $patient_name=$doctor->patient_name;
                                     ?>
