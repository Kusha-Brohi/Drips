<aside class="left-sidebar">
    <ul id="sidebarcolor" class="nav-bar  @if(!auth()->check()) d-none @endif navbar-inverse hidden-xs-down">
     <li class="nav-item">
    ...
    <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav ">
                <ul id="sidebarnav">
                    <li class="clearfix"></li>
                        ...
                        <li class=""><a class="has-arrow waves-effect waves-dark" href="{{url('admin/dashboard')}}" aria-expanded="false"><i class="flaticon-desktop-computer-screen-with-rising-graph"></i>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <!-- <li><a href="{{url('admin/banner')}}" class="">Banner Management</a></li> -->
                                 <li><a href="{{url('admin/users')}}" class="">User Management</a></li> 
     ...
     <!--                <li><hr></li> -->
                    ...
                    @endforeach
                      <li>
                        <a href="{{url('admin/report/consultation')}}">
