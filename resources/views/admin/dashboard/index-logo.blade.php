...
@section('content')
    ...
    @csrf
          ...
          <div class="card-body">
           ...
           <div class="clearfix"></div>
            ...
            <div class="col-lg-4 col-md-4">
                <img alt="" id="input-preview" src="{{ isset($logo)?asset($logo->img_path):asset('images/upload.jpg') }}" style="width:50%">
       ...
       <div class="row m-b-15">
            <div class="col-lg-4 col-md-4">
                <img alt="" id="input-preview" src="{{ isset($portal_logo)?asset($portal_logo->img_path):asset('images/upload.jpg') }}" style="width:50% ;background-color: #18689a">
        <div class="upload-photo">
