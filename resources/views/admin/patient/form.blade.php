...
<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('Weight') ? 'has-error' : ''}}">
    {!! Form::label('Weight', 'Weight (in kg)', ['class' => 'col-md-12 control-label']) !!}
    <div class="col-md-12">
	  <input type="hidden" value="kilograms" id="weightunits">
         <input type="number" class="form-control" placeholder="Weight" id="weight" name="Weight" value="{{$patient->Weight}}" required >
        {!! $errors->first('Weight', '<p class="help-block">:message</p>') !!}
    </div>
</div>

<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('height') ? 'has-error' : ''}}">
    {!! Form::label('height', 'Height (in cm)', ['class' => 'col-md-12 control-label']) !!}
    <div class="col-md-12">
	        <input type="hidden" value="meters" id="heightunits">
         <input type="text" class="form-control" placeholder="height" id="height" name="height" value="{{$patient->height}}" required>
...
<div class="form-group row justify-content-center left_css col-md-12">
    ...
    <div class="col-md-12">
	 ...
	 <button type="button" class="btn btn-success" value="computeBMI" onclick="computeBMI();">CALCULATE</button>
...
<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('Bmi') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
         <input type="number" class="form-control" placeholder="Bmi" name="Bmi" id="output" value="{{$patient->Bmi}}" readonly="">
...
<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('email') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
         <input type="email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Email" name="email" value="{{$patient->email}}" readonly="">
                    ...
                    @if($patient->Is_allergies == "yes")
                     ...
                     @endif
                      ...
                      @foreach($allergies as $key => $value)
                        <div class="remove_listing">
                          <div class="row d-flex align-items-center justify-content-start">
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="text" id="Yes_Answer" name="allergies[{{$key}}]" class="form-control YesaddHide" value="{{$value}}">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                              <a href="javascript:void(0)" onclick="window.location.href='{{ route('remove_allergies',[$patient->id ,$key]) }}'" id="removebtn" class="remove_this_field btn btn-danger btn-remove-customer">Remove</a>
                            </div>
                          </div>
							        ...
							        <!--   <a href="javascript:void(0)" onclick="window.location.href='{{ route('remove_allergies',[$patient->id ,$key]) }}'" class="delete_css">X</a> -->
              			      ...
              			      <div class="allergies_records_dynamic"></div>
                                 ...
                                 <div class="col-md-2">
                                    <div class="rigistertionlist">
                                      ...
                                      $allerygkey = key($allergies);
							                      	//$count_key = count((array)$allergies);
                                
									                     
								                        	?>
                                          <a id="extra-fields-allergies" href="javascript:void(0);" data-index="{{$allerygkey + 1}}" class="YesaddHide" >Add More</a>
                                    </div>
                                 </div>
              ...
              @else				
				     <div class="row">
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="rigistertionlist">
                                        <div class="allergies_records">
                                             <input type="text" id="Answer" name="allergies[1]" style=""  class="form-control addHide" placeholder="Allergies"> 
                                             <!-- <textarea rows="10" name="Current_medication1"></textarea> -->
                                </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-md-2">
                                    <div class="rigistertionlist">
                                          ...
                                          <a id="extra-fields-allergies" href="javascript:void(0);" data-index="2" id="hide_btn1" class="addHide">Add More</a>
                                    </div>
                                 </div>
                                 <div class="clearfix"></div>
                @endif
       ...
       <!--  {!! Form::label('past_medical_history', 'Past Medical History', ['class' => 'col-md-12 control-label']) !!} -->
           <div class="col-md-12">
                      ...
                      <!--  <input type="hidden" id="key" name="key" value="{{$key}}" > -->
                       <div class="row">
                          ...
                          <div class="row d-flex align-items-center justify-content-start">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                              <a href="javascript:void(0)" onclick="window.location.href='{{ route('PastMedicalHistory',[$patient->id ,$key]) }}'" class="remove_this_field btn btn-danger btn-remove-customer">Remove</a>
                            </div>
                          </div>
                               ...
                               <div class="Pastmedical_records_dynamic"></div>
                                 ...
                                 <div class="col-md-6">
                                    <div class="rigistertionlist">
                                      ...
                                      $PMH = ((array)$past_medical_history);
                                      end($PMH);
                                      $count_key = key($PMH);
                                        /*  $count_key = count((array)$past_medical_history);*/
            
								                            	?>
                                          <a id="extra-fields-Pastmedical" href="javascript:void(0);" data-index="{{$count_key + 1}}" id="hide_btn1" class="addmore">Add More</a>
                                    </div>
                                 </div>
                                 <div class="clearfix"></div>
                    @endif
                 ...
                 <div class="row">
                  ...
                  <input type="text" name="past_medical_history[1]" class="form-control" placeholder="Past Medical history" required="">
                                 ...
                                 <div class="col-md-6">
                                    <div class="rigistertionlist">
                                          <a id="extra-fields-Pastmedical" href="javascript:void(0);" data-index="2" id="hide_btn1">Add More</a>
                                    </div>
                                 </div>
                                 <div class="clearfix"></div>
                                    @endif
        ...
        <div class="col-md-12">
            ...
            @if($patient->Surgeries1 != '')
                  ...
                  <div class="row">
                          ...
                          <div class="row d-flex align-items-center justify-content-start">
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input type="text" data-key="{{$key}}" class="form-control" name="Surgeries1[{{$key}}]" value="{{$value}}" >
                                                                        </div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                              <a href="javascript:void(0)" onclick="window.location.href='{{ route('PastSurgicalHistory',[$patient->id ,$key]) }}'" class="remove_this_field btn btn-danger btn-remove-customer">Remove</a>
                                   </div>
                          </div>
				 ...
				 <div class="surgical_records_dynamic"></div>
                                 ...
                                 <div class="col-md-6">
                                    <div class="rigistertionlist">
                                      ...
                                      $Sur_His = ((array)$surgical_history);
                                      end($Sur_His);
                                      $count_key = key($Sur_His);
                                    
								                       //	$count_key = count((array)$surgical_history);
						
									?>
                                          <a id="extra-fields-surgical" href="javascript:void(0);" data-index="{{$count_key + 1}}" id="hide_btn1">Add More</a>
                                    </div>
                                 </div>
                                 <div class="clearfix"></div>
              ...
              @else
                      ...
                      <input type="text" name="Surgeries1[1]" class="form-control" placeholder="Past Surgical history"  required="">
				 ...
				 <div class="surgical_records_dynamic"></div>
                                 ...
                                 <div class="col-md-6">
                                    <div class="rigistertionlist">
                                          <a id="extra-fields-surgical" href="javascript:void(0);" data-index="2" id="hide_btn1">Add More</a>
                                    </div>
                                 </div>
                                 <div class="clearfix"></div>
                            @endif
        ...
        <div class="col-md-12">
            <div class="step_content_wrap">
                ...
                @if($patient->family_medical_condition != '')
                          ...
                          <div class="row d-flex align-items-center justify-content-start">
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                       <input type="text"  data-key="{{$key}}" class="form-control" name="family_medical_condition[{{$key}}]" value="{{$value}}" >
                                                                                          </div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                              <a href="javascript:void(0)" onclick="window.location.href='{{ route('FamilyHistory',[$patient->id ,$key]) }}'" class="remove_this_field btn btn-danger btn-remove-customer">Remove</a>
                                   </div>
                          </div>
					            ...
					            <div class="family_records_dynamic"></div>
                                 ...
                                 <div class="col-md-6">
                                    <div class="rigistertionlist">
												<?php
									    $fam_key = ((array)$family);
                                      end($fam_key);
                                      $count_key = key($fam_key);
                                  
									 //$count_key = count((array)$family);
						
									?>
                                          <a id="extra-fields-family" href="javascript:void(0);" data-index="{{$count_key + 1}}" id="hide_btn1">Add More</a>
                                    </div>
                                 </div>
                                 <div class="clearfix"></div>
                @else
                       ...
                       <input type="text" class="form-control" name="family_medical_condition[1]" placeholder="family Medical Conditions" required="">
                                 ...
                                 <div class="col-md-6">
                                    <div class="rigistertionlist">
                                          <a id="extra-fields-family" href="javascript:void(0);" data-index="2" id="hide_btn1">Add More</a>
                                    </div>
                                 </div>
                                 <div class="clearfix"></div>
...
<div class="step_content_wrap">
                    ...
                    <ul>
                     ...
                     @else
                       ...
                       @endif
								 ...
								 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="rigistertionlist">
                                       <label style="display:none;" id="label_hide">Job Title</label>
                                       <input type="text" style="display:none;"  id="job" name="job_title" class="form-control" placeholder="job title" value="{{$patient->job_title}}" >
                                    </div>
                                 </div>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="rigistertionlist">
                                       <label style="display:none;" id="label_employer">Employer name</label>
                                       <input type="text" style="display:none;"  id="emp_name" class="form-control" name="employee_name" placeholder="employee name"  value="{{$patient->employee_name}}">
                                    </div>
                                 </div>
            ...
            <div class="step_content_wrap">
               ...
               <div class="row">
                ...
                @foreach($currentmedication as $key => $value)
                         <div class="remove_listing">
                          <div class="row d-flex align-items-center justify-content-start">
                            <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" name="Current_medication1[{{$key}}]" value="{{$value}}" >
                                  </div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                              <a href="javascript:void(0)" onclick="window.location.href='{{ route('CurrentMedication',[$patient->id ,$key]) }}'" class="remove_this_field btn btn-danger btn-remove-customer">Remove</a>
                                   </div>
                          </div>
					  ...
					  <div class="customer_records_dynamic"></div>
                                 ...
                                 <div class="col-md-2">
                                    <div class="rigistertionlist">
                                      ...
                                      end($currentmedication);
                                      $count_key = key($currentmedication);
								    //	$count_key = count((array)$currentmedication);
						
									?>
                                          <a id="extra-fields-customer" href="javascript:void(0);" data-index="{{$count_key + 1}}" id="hide_btn1">Add More</a>
                                    </div>
                                 </div>
                                 <div class="clearfix"></div>
                @else
                  ...
                  <div class="row">
                       ...
                       <input type="text" name="Current_medication1[1]" class="form-control" style="" placeholder="Current Medication" >
                      ...
                      <!-- <textarea rows="10" name="Current_medication1"></textarea> -->
                                 ...
                                 <div class="col-md-2">
                                    <div class="rigistertionlist">
                                          <a id="extra-fields-customer" href="javascript:void(0);" data-index="2" id="hide_btn1">Add More</a>
                                    </div>
                                 </div>
                                 <div class="clearfix"></div>
                                       ...
                                       <select name="blood_type" class="form-control">
                                          <option value="" disabled>
                                             Select Your Blood Group
										       ...
										       @if($patient->blood_type == "Dont know")
                                          <option value="Dont know" selected="">
                                             Don't know
                                          </option>
                                          @else
