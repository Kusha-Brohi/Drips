                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       'style' => 'display:inline'
                                        ...
                                        {!! Form::close() !!}
                                        <!--  -->
<!-- <a href="{{ url('/admin/doctor/view/' . $item->id ) }}" target="popup" onclick="window.open('','name','width=600,height=400')">Open page in new window</a> -->

                                    <a  id="link" href="{{ url('/admin/doctor/view/' . $item->id ) }}" 
