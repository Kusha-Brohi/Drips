...
<div style=""> <!-- main Div -->
	...
	<div style="margin: 50px auto; color: #2a3342; border:7px solid #eee; ">
		...
		<h2 style="font-size: 16px; font-weight: inherit;">Dear {{$patient_email['name']}},</h2>
		<p style="font-size: 16px; font-weight: inherit;">Your portal account has been generated successfully please login to your acccount</p>
...
<p style="font-size: 16px; font-weight: inherit;"><a href="https://dripsmedical.com/portal/patient-dashboard/steps/{{$patient_email['id']}}">Click Here</a> </p>
