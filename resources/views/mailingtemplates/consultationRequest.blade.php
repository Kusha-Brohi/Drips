...
<div style=""> <!-- main Div -->
	...
	<div style="margin: 50px auto; color: #2a3342; border:7px solid #eee; ">
		...
		<h2 style="font-size: 16px; font-weight: inherit;">Dear <b>{{$emaildata['name']}}</b>,</h2>
		<p style="font-size: 16px; font-weight: inherit;">You have an upcoming appointment with  <b>{{$emaildata['patientname']}}</b> on <b>{{$emaildata['date']}}</b> at <b>{{$emaildata['timing']}}</b>. The appointment type is <b>{{$emaildata['booking_type']}}</b>.</p>
		...
		<p style="font-size: 16px; font-weight: inherit;">Link: <a href="{{$url}}">Click Here</a></p>
		@else
			<h2 style="font-size: 16px; font-weight: inherit;">Dear <b>{{$emaildata['name']}}</b>,</h2>
		<p style="font-size: 16px; font-weight: inherit;">You have an upcoming appointment with  <b>{{$emaildata['patientname']}}</b>  The appointment type is <b>{{$emaildata['booking_type']}}</b>.</p>
		<p style="font-size: 16px; font-weight: inherit;">send zoom meeting link to patient's email: <b>{{$emaildata['patientemail']}}</b></p>
		<p style="font-size: 16px; font-weight: inherit;">Please click the below link and view ECC card!</p>			
		<p style="font-size: 16px; font-weight: inherit;">Link: <a href="{{$url}}">Click Here</a></p>
		@endif
