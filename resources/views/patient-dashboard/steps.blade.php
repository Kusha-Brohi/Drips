                     ...
                     <div class="stepwizard">
                        <div class="stepwizard-row setup-panel">
                          ...
                          <!--  <div class="stepwizard-step">
                           ...
                           <div class="stepwizard-step">
						   @if($userdata->status_Incomplete == "Yes")
                              <a href="#step-1"  id='tab-step-1' onclick="return paymentFunction();" type="button" class="btn btn-default btn-circle">Payment</a>
								 <input type="hidden" id="status_Incomplete" name="status_Incomplete" value="{{$userdata->status_Incomplete}}">
							@else
     ...
     <input type="hidden" name="fname" value="{{$userdata->name}}">
      <input type="hidden" value="patient"  name="role" id="role" readonly>
                     ...
                     <div id="error-nwl"></div>
                                 ...
                                 <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="rigistertionlist">
                                       ...
                                       <input type="text" id="Birth" name="DOB" required="" placeholder="Date of birth" value="{{$popupdata->DOB}}">
										@endif
									
									  @if((new \Jenssegers\Agent\Agent())->isMobile())
									  
                                       <input type="date"  name="DOB" required="" placeholder="Date of birth" value="{{$popupdata->DOB}}" max="{{date('Y-m-d')}}">
									@endif
               ...
               <div class="col-md-2 col-sm-2 col-xs-12">
                   <div class="rigistertionlist">
                       <label>BMI</label>
                       <input type="text" name="Bmi" value="{{$popupdata->Bmi}}" placeholder="BMI" id="output" required="" hidden>
					   <div>
					    <input type="text" name="Bmi" value="{{$popupdata->Bmi}}" placeholder="BMI" id="showoutput" readonly>
					   </div>
                   </div>
               </div>
             <div class="col-md-12 col-sm-12 col-xs-12">
   ...
   @endif
                    ...
                    @if($popupdata->Is_allergies == "yes")
                     ...
                     @endif
                      ...
                      @foreach($allergies as $key => $value)
                          ...
                          <input type="text" id="Yes_Answer" data-key="{{$key}}" name="allergies[{{$key}}]" value="{{$value}}" class="YesaddHide" >
                       ...
                       @endforeach
                                 ...
                                 <div class="col-md-2">
									...
									?>
                                          <a id="extra-fields-allergies" href="javascript:void(0);" data-index="{{$allerygkey + 1}}" id="hide_btn1">Add More</a>
              ...
              @else
                               ...
                               <div class="row">
                                 <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="rigistertionlist">
                                        <div class="allergies_records">
                                             <input type="text" id="Answer" name="allergies[1]" style=""  class="addHide" placeholder="Allergies"> 
                                             <!-- <textarea rows="10" name="Current_medication1"></textarea> -->
                                </div>
                                    </div>
                                 </div>
                ...
                @endif
                 ...
                 <div class="row">
                  ...
                  <input type="text" name="past_medical_history[1]" placeholder="Past Medical history" required="">
            ...
            @if($popupdata->Surgeries1 != '')
                                 ...
                                 <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="rigistertionlist">
                                        <div class="surgical_records">
                                             ...
                                             <input type="text" data-key="{{$key}}" name="Surgeries1[{{$key}}]" value="{{$value}}" >
                                             <!-- <textarea rows="10" name="Current_medication1"></textarea> -->
                                        </div>
                                    </div>
                                 </div>
              ...
              @else
                      ...
                      <input type="text" name="Surgeries1[1]" placeholder="Past Surgical history"  required="">
            ...
            @endif
                ...
                @foreach($family as $key => $value)
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="rigistertionlist">
                                       <input type="text" data-key="{{$key}}" name="family_medical_condition[{{$key}}]" value="{{$value}}" >
                                    </div>
                                 </div> 
                              </div>
                @endforeach
                ...
                @else
                       ...
                       <input type="text"  name="family_medical_condition[1]" placeholder="family Medical Conditions" required="">
              ...
              <li class="dis_in_block"><label><input type="radio" class="do_u_Alcohol" value="no" name="do_u_Alcohol">No</label></li>
               ...
               <div class="row">
                                 <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="rigistertionlist">
                                        <div class="customer_records">
                                             <input type="text" name="Current_medication1[{{$key}}]" value="{{$value}}" >
                                             <!-- <textarea rows="10" name="Current_medication1"></textarea> -->
                                        </div>
                                    </div>
                                 </div>
                ...
                <div class="row">
                       ...
                       <input type="text" name="Current_medication1[1]" style="" placeholder="Current Medication">
...
$type = "-" . 'ecc_charge';
 $txn_ref = $txn_ref = $appoint_code . $appointment_id .$type;
 // dd($txn_ref);
$amount = $charges; 
//dd($amount);
$currency = "566";//"844";
...
<script type="text/javascript">
            ...
            function computeBMI() {
				...
				var showoutput = Math.round(BMI * 100) / 100
                document.getElementById("showoutput").value = showoutput;
        /*        if (output < 18.5)
      ...
      <script>
         ...
         var curStep = $(this).closest(".setup-content"),
           ...
           curInputs = curStep.find("input[type='text'],input[type='date']"),
           isValid = true;
...
<script type="text/javascript">
  $(".btn-step").click(function(){
    ...
    var container = obj.closest("div.setup-content");
      ...
      //console.log(container.find("input[type=date]"));
...
function paymentFunction() {
	var status_Incomplete = document.getElementById("status_Incomplete").value;
	//alert(status_Incomplete);
	if(status_Incomplete == 'Yes'){
              $.toast({
                heading: 'Error!',
                position: 'bottom-right',
                text:  'Please fill the registration process',
                loaderBg: '#ff6849',
                icon: 'error',
                hideAfter: 3000,
                stack: 6
