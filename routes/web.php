...
//============================================================//
	...
	Route::any('/remove-pat_image/{id}', 'Admin\\PatientController@removePatImg')->name('remove_pat_image'); 

	Route::any('/remove_allergies/{id}/{key}', 'Admin\\PatientController@remove_allergies')->name('remove_allergies');

    Route::any('/remove_past_medical_history/{id}/{key}', 'Admin\\PatientController@PastMedicalHistory')->name('PastMedicalHistory');

    Route::any('/remove_past_surgical_history/{id}/{key}', 'Admin\\PatientController@PastSurgicalHistory')->name('PastSurgicalHistory');

    Route::any('/remove_FamilyHistory/{id}/{key}', 'Admin\\PatientController@FamilyHistory')->name('FamilyHistory');

    Route::any('/remove_current_medication/{id}/{key}', 'Admin\\PatientController@CurrentMedication')->name('CurrentMedication');
...
Route::post('/physician-dashboard/end_consultation','PhysicianController@end_consultation')->name('end_consultation');
    ...
    ///admin access delete consultaion records///
Route::any('physician-dashboard/Deleteconsultation','PhysicianController@DeleteConsultation')->name('DeleteConsultation');
...
Route::post('admin_call_ecc_popup','HomeController@Admin_call_ecc_popup')->name('admin_call_ecc_popup');
...
///admin acess consultaion records///

Route::get('admin/report/consultation', 'Admin\\AdminController@Consultation');

//admin access doctor ///
Route::get('admin/doctor/view/{id}', 'Admin\\DoctorController@viewuser');
///admin can return back to admin panel 
Route::get('loginasadmin', 'Admin\\DoctorController@loginasAdmin')->name('loginasAdmin');
//admin access Patient ///
Route::get('admin/patient/view/{id}', 'Admin\\PatientController@viewPatient');
///admin can return back to Patient 
Route::get('patientAdmin', 'Admin\\PatientController@patientloginasAdmin')->name('patientAdmin');
