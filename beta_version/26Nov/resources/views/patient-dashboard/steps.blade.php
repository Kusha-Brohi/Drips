                       ...
                       @endif
                                 ...
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="rigistertionlist">
                                       ...
                                       <input type="text"  name="job_title" placeholder="job title" value="{{$popupdata->job_title}}" >
                                    </div>
                                 </div>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="rigistertionlist">
                                       <label id="label_employer">Employer name</label>
                                       <input type="text"  name="employee_name" placeholder="employee name"  value="{{$popupdata->employee_name}}">
                                    </div>
                                 </div>
                                 @else
									     <div class="col-md-6 col-sm-6 col-xs-12">
...
// dd($return_url);
 ...
 // dd($appointment_id);
  ...
  $gtpay_tranx_curr = "566"; //566 niara and 844 is usd
