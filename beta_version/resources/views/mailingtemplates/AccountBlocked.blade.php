...
<div style=""> <!-- main Div -->
	...
	<div style="margin: 50px auto; color: #2a3342; border:7px solid #eee; ">
		...
		<h2 style="font-size: 16px; font-weight: inherit;">Dear {{$blocked_email['name']}}! Your Portal account has been locked. Contact your support person to unlock it, then try again.!</h2>
		<p style="font-size: 16px; font-weight: inherit;"></p>
