  ...
  <div id="menu2" class="tab-pane fade in active">
   <div class="medicalhistorybox1">
     <form method="post" action="{{route('patient_medical_history_edit')}}">
          ...
          <input type="hidden" id="past_medical_history" name="history_title" value="past_medical_history">
        ...
        <div class="medicalhistorybox1body">
            ...
            <!-- <input type="hidden"  name="null_value" value="null"> -->
            <ul>
          <li style="background-color: #edf3f6;" >
            
          <input  class="edit_pTag edit_pTag_mh"  id="test" type="text" name="history_description[]" value="{{$value}}">
      
            </li> 
          </ul>
            @else
            <!-- <input type="hidden" name="null_value" value="not_null"> -->
					<ul>
          <li style="background-color: #edf3f6;">
...
<script type="text/javascript">
    ...
    $('.pull-right').click(function(){
      ...
      $(this).closest('.medicalhistorybox1header').siblings('.medicalhistorybox1body').find('ul').css({"border-style": "solid", "border-width": "thin", "border-color":"black", "height":"25%" });
