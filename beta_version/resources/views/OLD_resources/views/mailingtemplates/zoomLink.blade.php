...
<div style=""> <!-- main Div -->
	...
	<div style="margin: 50px auto; color: #2a3342; border:7px solid #eee; ">
		...
		<h2 style="font-size: 16px; font-weight: inherit;">Dear patient! Please Join the link {{$data['description']}} </h2><br>
	<!-- 	<p style="font-size: 16px; font-weight: inherit;">{{$data['zoom_id_link']}}</p> -->
		</div>
