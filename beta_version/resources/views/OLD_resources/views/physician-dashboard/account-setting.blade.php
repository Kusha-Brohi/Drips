           ...
           <input type="text" name="name" placeholder="Mark Manson" value="{{Auth::user()->profile->name}}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="billinglist profilelist1">
                                            ...
                                            <input type="Date" min="{{date("Y-m-d")}}" name="DOB" placeholder="" value="{{Auth::user()->profile->DOB}}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="billinglist profilelist1">
											...
											?>       
                                            <select class="js-states browser-default select2" name="expertise"  required>
            ...
            <select type="text" name="expertise[]" class="multiselect" multiple="multiple" role="multiselect">          
              <option  disabled >Expertise</option>            
              <option value="Fever">Fever</option>
              <option value="Heahache">Heahache</option>
              <option value="Nasal Congestion">Nasal Congestion</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="billinglist profilelist1">
                                                 <label>Fee</label>
                                               <input type="text" name="price" placeholder="$100" value="{{Auth::user()->profile->price}}">
                                            </div>
                                    </div>
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="billinglist profilelist1">
                                               ...
                                               <input type="text" name="residency"  value="{{Auth::user()->profile->residency}}">
                                            </div>
                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="billinglist profilelist1">
                                               ...
                                               <input type="text" name="medical_school"  value="{{Auth::user()->profile->medical_school}}">
                                            </div>
                                    </div>
