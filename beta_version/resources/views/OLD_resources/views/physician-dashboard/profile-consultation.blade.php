                ...
                <div class="row" id="physical_row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            <br>
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button  data-col-name="GENERAL_APPEARANCE" class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
                <br>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button   data-col-name="HEAD_AND_NECK" class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
                <br>              <div class="row" id="physical_row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button  data-col-name="RESPIRATORY_CHEST" class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
                <br>              <div class="row" id="physical_row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button  data-col-name="CARDIOVASCULAR"  class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
                <br>              <div class="row" id="physical_row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button  data-col-name="ABDOMEN" class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
                <br>              <div class="row" id="physical_row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button  data-col-name="GENITOURINARY" class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
                <br>              <div class="row" id="physical_row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button  data-col-name="MUSCULOSKELETAL" class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
                <br>              <div class="row" id="physical_row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button  data-col-name="NEURO" class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
                <br>              <div class="row" id="physical_row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button  data-col-name="HEME_LYMPH"  class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
                  ...
                  <div class="row" id="physical_row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button  data-col-name="SKIN_INTEGUMENARY" class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
                  ...
                  <div class="row" id="physical_row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 no-margin">
                        <div class="generalpara new_height generalpara_custom">
                            ...
                            @if(Auth::user()->customer_status == '3' && $_GET['status'] != 'end')
                             <button  data-col-name="PSYCH" class="savebtn edit_btn" id="editbutton" >EDIT</button>
                            @endif
                        </div>
                    </div>
                </div>
