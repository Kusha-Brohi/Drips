...
<section class="steps_sec">
                     ...
                     <div class="stepwizard">
                        <div class="stepwizard-row setup-panel">
                           <div class="stepwizard-step">
                              <a href="#step-1"  id='tab-step-1'type="button" class="btn btn-circle btn-default btn-primary">Personal Detail</a>
                           </div>
                           <div class="stepwizard-step">
                              <a href="#step-2"  id='tab-step-2'type="button" class="btn btn-default btn-circle">Contact Info</a>
                           </div>
                           <div class="stepwizard-step">
                              <a href="#step-3"  id='tab-step-3'type="button" class="btn btn-default btn-circle">Allergies</a>
                           </div>
                           <div class="stepwizard-step">
                              <a href="#step-4"  id='tab-step-4'type="button" class="btn btn-default btn-circle">Past Medical History</a>
                           </div>
                           <div class="stepwizard-step">
                              <a href="#step-5"  id='tab-step-5'type="button" class="btn btn-default btn-circle">Past Surgical History</a>
                           </div>
                           <div class="stepwizard-step">
                              <a href="#step-6"  id='tab-step-6'type="button" class="btn btn-default btn-circle">Family History</a>
                           </div>
                           <div class="stepwizard-step">
                              <a href="#step-7"  id='tab-step-7'type="button" class="btn btn-default btn-circle">Social History</a>
                           </div>
                           <div class="stepwizard-step">
                              <a href="#step-8"  id='tab-step-8'type="button" class="btn btn-default btn-circle">Current Medications</a>
                           </div>
                           <div class="stepwizard-step">
                              <a href="#step-9"  id='tab-step-9'type="button" class="btn btn-default btn-circle">Blood Type:</a>
                           </div>
                           <div class="stepwizard-step">
                              <a href="#step-10" id='tab-step-10' type="button" class="btn btn-default btn-circle">Self Assessment</a>
                           </div>
                           <div class="stepwizard-step">
                              <a href="#step-11" id='tab-step-11' type="button" class="btn btn-default btn-circle">Upload profile</a>
                           </div>
                          <!--  <div class="stepwizard-step">
     ...
     <input type="hidden" name="fname" value="{{$userdata->name}}">
      <input type="hidden" value="patient"  name="role" id="role" readonly>
                     ...
                     <div id="error-nwl"></div>
                                 ...
                                 <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="rigistertionlist">
                                       ...
                                       <input type="date" id="Birth" name="DOB" required="" placeholder="Date of birth" value="{{$popupdata->DOB}}">
                                    </div>
                                 </div>
                   ...
                   <div class="rigistertionlist">
                       ...
                       <input type="number" id="weight" value="{{$popupdata->Weight}}"  name="Weight" placeholder="Weight in Kg" required="">
                   </div>
               </div>
               <div class="col-md-2 col-sm-2 col-xs-12">
                   <div class="rigistertionlist">
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                <span id="BMI_msg">
                      ...
                      <input type="radio" name="Gender" class="rdSelect" value="male" required="required">Male</label></li>
										   <li class="dis_in_block"><label><input type="radio"                                    
                        name="Gender" class="rdSelect"  value="female" required="required">Female</label></li>
												@endif
  ...
  @else
    <ul>
                                          <li class="dis_in_block"><label><input type="radio" name="material_status" class="Ismarital" value="Single" required="" >Single</label></li>
                                          <li class="dis_in_block"><label><input type="radio" name="material_status" class="Ismarital" value="Married" required="">Married</label></li>
                                       </ul>
  @endif
                                    </div>
                                    <!-- <div class="radio_btns">
                              ...
                              ?>
                                    ...
                                    <div class="radio_btns">
                                       <label>Are you allergic to any medication or do you have any type of allergies?</label>
										@if($allergies[0] == "yes")
									   <ul>
                                          <li class="dis_in_block"><label><input type="radio" value="yes" name="allergies[0]" checked>Yes</label></li>
                                          <li class="dis_in_block"><label><input  type="radio" value="no" name="allergies[0]" >No</label></li>
                                       </ul>
									   @elseif($allergies[0] == "no")
									   <ul>
											
                                          <li class="dis_in_block"><label><input  type="radio" value="yes" name="allergies[0]" >Yes</label></li>
                                          <li class="dis_in_block"><label><input  type="radio" value="no" name="allergies[0]" checked>No</label></li>
                                       </ul>
									   @else
										  <ul>
											<input type="hidden" value="" name="Is_allergies">
                                          <li class="dis_in_block"><label><input type="radio"  id="yes" value="yes" name="allergies[0]">Yes</label></li>
                                          <li class="dis_in_block"><label><input  type="radio" id="no" value="no" name="allergies[0]">No</label></li>
                                       </ul> 
                                    ...
                                    <div class="rigistertionlist">
                                        <div class="allergies_records">
											@foreach($allergies as $value)
											    @if($value == yes)   
                        <!--  <input type="text" id="Yes_Answer"  name="allergies[1]" value="{{$value}}" class="addHide">-->
                          @else
                          <input type="text" id="Answer" name="allergies[1]" value="{{$value}}" class="addHide" readonly>
                          @endif
											 @endforeach
                 ...
                 $surgical_history = json_decode($popupdata->Surgeries1);
                                 ...
                                 <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="rigistertionlist">
                                        <div class="surgical_records">
                                             ...
                                             <input type="text" name="Surgeries1[0]" value="{{$value}}" readonly>
                                             <!-- <textarea rows="10" name="Current_medication1"></textarea> -->
                                        </div>
                                    </div>
                                 </div>
                      ...
                      // dd($currentmedication);
                        ?>  
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="rigistertionlist">
                                       <input type="text"  name="family_medical_condition[0]" value="{{$value}}" readonly>
                                    </div>
                                 </div> 
                              </div>
							  @endforeach
                                 ...
                                 <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="rigistertionlist">
                                        <div class="customer_records">
                                             <input type="text" name="Current_medication1[0]" value="{{$value}}" readonly>
                                             <!-- <textarea rows="10" name="Current_medication1"></textarea> -->
                                        </div>
                                    </div>
                                 </div>
...
?>
          <!-- <input type="hidden" name="ecc_charges" value="10"> -->
                                     </div>
...
<input type="hidden" name="gtpay_cust_name" value="{{$userdata->name}}" />
                            ...
                            <?php
                             ...
                             // dd($allergies);
                              ...
                              @foreach($allergies as $key => $value)
                                  @if($value == yes)
                                  <p class="hide_yes">{{$value}}</p>
                                  @else
                               <p class="txt_red normal_txt">{{$value}}</p>
                               @endif
                               @endforeach
                               @elseif($allergies[0] == No)
                                    <p class="txt_red normal_txt">{{$allergies[0]}}</p>
                               @endif 
 ...
 <!-- <ol class="carousel-indicators">
    ...
    <!-- Left and right controls -->
          ...
          <!-- <button id="txt" class="head_alernate"   style="margin-left: 50%; border-color:#F48148;  margin-top: 13%;">Submit</button>  -->
           ...
           <a class="head_blue" style="margin-left: 50%; border-color:#F48148;  margin-top: 13%;" href="{{url('patient-dashboard/consultation')}}">Book Appointment</a>
                      </div>
...
<!-- <script type="text/javascript">
  this.container.find('a.btn-step').on('click', function () {
   ...
   $.toast(
        {
          heading:'Success!',
          position:'bottom-right',
          text:'Marital Status field is required!',
          loaderBg:'#ff6849',
       icon:'error',
          hideAfter:3000,
          stack:6
