...
{   
    ...
    public function MyOrder(){
       ...
       {
      $myConsultations = DB::table('consultation')->where('patient_id', Auth::user()->id)->where('is_deleted',0)->get();
  ...
  public function MyTest(){
    ...
    public function SheduledConsultation(){
       ...
       {
        $consultation = DB::table('consultation')->where('patient_id',Auth::user()->id)->where('doctor_id','>',0)->where('is_deleted',0)->get();
    ...
    public function PastConsultation(){
            ...
            where('date','<',$currentDate)->where('is_deleted',0)->get();
   ...
   public function Complaint(){
        $Complaint = DB::table('consultation')->where('patient_id',Auth::user()->id)->where('doctor_id','>',0)->orderBy('id','desc')->where('is_deleted',0)->get();
    ...
    public function Consultation(){
       ...
       else
       {
            $id = $_GET['id'];
            //dd($id);
            $patient_data = DB::table('consultation')->where('id', $id)->where('is_deleted',0)->first();
...
$prescriptionDate = DB::table('prescription')->where('consultation_id',$consult_id)->orderBy('updated_at', 'desc')->first()->updated_at;
			//dd($prescriptionDate);
		...
		$data['date'] = date_format(date_create($prescriptionDate),"n/j/Y"); 
...
/*  dd($data);
    ...
    {   
       ...
       // dd($doctor_id);
        ...
        $Docdata = DB::table('profiles')->where('user_id',$doctor_id)->first();
        $subjectives = DB::table('subjectives')->where('consultation_id',$consult_id)->first();
		$OrderDate = DB::table('patient_orderlist')->where('consultation_id',$consult_id)->orderBy('updated_at', 'desc')->first()->updated_at;
		$fname = $userdata->fname;
		$lname = $userdata->lname;
		 $space = " ";
		$data['name'] = $fname . $space. $lname;
        ...
        $data['sex'] = $userdata->Gender;
		$data['allergies'] = $userdata->allergies;
		$data['date'] = date_format(date_create($OrderDate),"n/j/Y"); 
